...
[![Docker Pulls](https://img.shields.io/docker/pulls/alvistack/gitlab-runner-14.8.svg)](https://hub.docker.com/r/alvistack/gitlab-runner-14.8)
...
Configure GitLab Runner (`/etc/gitlab-runner/config.toml`):
    ...
    [[runners]]
      ...
      [runners.docker]
        ...
        image = "alvistack/gitlab-runner-14.8"
        memory = "8192m"
        memory_swap = "8192m"
...
Start GitLab Runner:
    ...
    # Pull latest image
    docker pull alvistack/gitlab-runner-14.8
