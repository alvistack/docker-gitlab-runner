...
[![Docker Pulls](https://img.shields.io/docker/pulls/alvistack/gitlab-runner-15.2.svg)](https://hub.docker.com/r/alvistack/gitlab-runner-15.2)
...
## Supported Tags and Respective Packer Template Links
  ...
  - [`alvistack/gitlab-runner-15.2`](https://hub.docker.com/r/alvistack/gitlab-runner-15.2)
      - [`packer/docker-15.2/packer.json`](https://github.com/alvistack/docker-gitlab-runner/blob/master/packer/docker-15.2/packer.json)
...
Configure GitLab Runner (`/etc/gitlab-runner/config.toml`):
    ...
    [[runners]]
      ...
      [runners.docker]
        ...
        image = "alvistack/gitlab-runner-15.2"
        memory = "8192m"
        memory_swap = "8192m"
...
Start GitLab Runner:
    ...
    # Pull latest image
    docker pull alvistack/gitlab-runner-15.2
