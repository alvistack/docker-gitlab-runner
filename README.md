...
[![Docker Pulls](https://img.shields.io/docker/pulls/alvistack/gitlab-runner-14.10.svg)](https://hub.docker.com/r/alvistack/gitlab-runner-14.10)
...
## Supported Tags and Respective Packer Template Links
  ...
  - [`alvistack/gitlab-runner-14.10`](https://hub.docker.com/r/alvistack/gitlab-runner-14.10)
      - [`packer/docker-14.10/packer.json`](https://github.com/alvistack/docker-gitlab-runner/blob/master/packer/docker-14.10/packer.json)
...
Configure GitLab Runner (`/etc/gitlab-runner/config.toml`):
    ...
    [[runners]]
      ...
      [runners.docker]
        ...
        image = "alvistack/gitlab-runner-14.10"
        memory = "8192m"
        memory_swap = "8192m"
...
Start GitLab Runner:
    ...
    # Pull latest image
    docker pull alvistack/gitlab-runner-14.10
